...
export default function Comprar() {
  ...
  return (
    <>
      <div className="containerComprarDados">
        <div className="contentComprarDados">
          <div className="divInfoComprarDados">
            <div>
              <label htmlFor="cpfcnpj">Seu CPF / CNPJ</label>
              <input id="cpfcnpj" type="text" placeholder="Digite seu CPF ou CNPJ" />
            </div>
            <div className="mt-3">
              <label htmlFor="usdtDestino">Endereço USD₮ de destino</label>
              <input id="usdtDestino" type="text" placeholder="Digite o endereço USD₮ de destino" />
            </div>
            ...
            <div className="blocoConversao mt-3">
              ...
              <div className="conversaoInfo mt-4">
                <div className="d-flex justify-content-between flex-column">
                  ...
                  <div className="d-flex justify-content-between">
                    <span className="valorConversao">Valor máximo</span>
                    <span>R$ 300000,00</span>
                  </div>
